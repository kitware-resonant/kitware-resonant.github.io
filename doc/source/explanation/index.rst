...
We are able to do the same rich application building and problem solving you may be used to with Resonant, but we have learned many lessons and improved our process, knowledge, and understanding in moving to Resonant. And of course, we are still supporting Girder  projects that already exist—we are simply building *new* projects with the enhanced insight and understanding we have captured in the Resonant family of tools.
